...
while True:
    ...
    print("9. Delete fisrt node")
    print("10. Delete last node")
    print("11. Delete any node")
    print("12. reverse the list")
    print("13. Bubble sort by exchanging data")
    print("14. Bubble sort by excganging list")
    print("15. Merge sort")
    ...
    if option == 1:
        ...
        data = int(
            input("Enter element at which the cycle has to be inserted :  "))
        list.insert_cycle()
    elif option == 17:
        if list.has_cycle():
